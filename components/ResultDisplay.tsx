            ...
            <div className="w-full lg:w-7/12 flex flex-col justify-center">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 lg:mb-10 gap-5">
                    ...
                    <div className="flex bg-neutral-900 p-1 rounded-xl border border-neutral-800">
                        ...
                        <button
                            ...
                            className={`px-5 py-2 rounded-lg text-sm font-bold tracking-widest uppercase transition-all ${unitSystem === 'imperial' ? 'bg-brand text-white' : 'text-zinc-500 hover:text-zinc-300'}`}
                        >
                            Imperial
                        </button>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6 mb-8 lg:mb-10">
                    ...
                    <div className="bg-neutral-900 rounded-2xl p-8 lg:p-9 border border-neutral-800 relative overflow-hidden group hover:border-brand/30 transition-colors">
                        ...
                        <p className="text-sm font-bold text-brand uppercase tracking-[0.3em] mb-4">Height</p>
                    ...
                    <div className="bg-neutral-900 rounded-2xl p-8 lg:p-9 border border-neutral-800 relative overflow-hidden group hover:border-brand/30 transition-colors">
                        ...
                        <p className="text-sm font-bold text-brand uppercase tracking-[0.3em] mb-4">Weight</p>
