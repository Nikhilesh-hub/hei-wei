...
export function FallingPattern({
    color = 'rgba(0, 165, 98, 0.2)', // Adjusted for better visibility in Hei-wei
    ...
    return (
        <div className={cn('relative h-full w-full p-1', className)}>
            ...
            <div
                className="absolute inset-0 z-1 dark:brightness-200"
                style={{
                    backdropFilter: `blur(${blurIntensity})`,
                    backgroundImage: `radial-gradient(circle at 50% 50%, transparent 0, transparent 2px, var(--background) 2px)`,
