...
export const LogoIcon: React.FC<{ className?: string }> = ({ className = "w-10 h-10 text-violet-400" }) => (
...
export const SpinnerIcon: React.FC<{ className?: string }> = ({ className = "w-10 h-10 text-violet-400" }) => (
...
export const UserIcon: React.FC<{ className?: string }> = ({ className = "w-full h-full" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="0.5">
...
export const QuickSnapInstructionIcon: React.FC<{ className?: string }> = ({ className = "w-24 h-24 text-violet-400" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 64 64" fill="none" stroke="currentColor" strokeWidth="2.5">
...
export const BodyScanIcon: React.FC<{ className?: string }> = ({ className = "w-10 h-10 text-brand" }) => (
...
export const SlashIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
    </svg>
);

export const DoorIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 4h8a2 2 0 012 2v14a2 2 0 01-2 2H8a2 2 0 01-2-2V6a2 2 0 012-2z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M14 12h.01" />
    </svg>
);
...
export const BoxIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
