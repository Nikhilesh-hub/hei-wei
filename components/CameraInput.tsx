...
export const CameraInput: React.FC<CameraInputProps> = ({ onAnalyze, onBack }) => {
    ...
    const guidelinesContent = [
        { title: "Camera Level", desc: "Hold device at chest height" },
        { title: "Full Body", desc: "Keep entire body in frame" },
        { title: "Background", desc: "Use a clean, simple background" },
        { title: "Posture", desc: "Stand straight, arms slightly apart" }
    ];
